...
/* Homepage */
	$options[] = array( 'name' => __( 'Homepage', 'woothemes' ),
	    				'type' => 'heading',
	    				'icon' => 'homepage' );
	$options[] = array( 'name' => __( 'Display Werbe Banner', 'manuel' ),
    					'desc' => __( 'Display Werbebanner auf der Homepage?', 'manuel' ),
    					'id' => $shortname.'_homepage_werbe_check',
    					'std' => 'false',
    					'class' => 'collapsed',
    					'type' => 'checkbox' );
	$options[] = array( 'name' => __( 'Werbe Banner', 'manuel' ),
	    				'desc' => __( 'Banner code eingeben', 'Manuel' ),
	    				'id' => $shortname . '_homepage_werbe_banner',
	    				'std' => 'Werbung auf der homepage',
	    				'class' => 'hidden',
	    				'type' => 'textarea' );		
	$options[] = array( 'name' => __( 'Slider', 'manuel' ),
    					'type' => 'subheading' );
	$options[] = array( 'name' => __( 'Display a slider', 'manuel' ),
    					'desc' => __( 'Display a slider on the homepage?', 'manuel' ),
    					'id' => $shortname.'_homepage_slider_check',
    					'std' => 'false',
    					'class' => 'collapsed',
    					'type' => 'checkbox' );
	$options[] = array( 'name' => __( 'Slider shortcode', 'manuel' ),
	    				'desc' => __( 'shortcode für eigenen slider eingeben', 'Manuel' ),
	    				'id' => $shortname . '_homepage_slider',
	    				'std' => 'shortcode für eigenen slider eingeben',
	    				'class' => 'hidden',
	    				'type' => 'textarea' );			
	...
	$options[] = array( 'name' => __( 'Text after Banner', 'manuel' ),
	    				'desc' => __( 'Text auf der hompage anzeigen', 'Manuel' ),
	    				'id' => $shortname . '_homepage_text',
	    				'std' => 'Text auf der homepage',
	    				'class' => 'hidden',
	    				'type' => 'textarea' );	
	$options[] = array( 'name' => __( 'Display news', 'manuel' ),
    					'desc' => __( 'Display a news feed on the homepage?', 'manuel' ),
    					'id' => $shortname.'_homepage_news_check',
    					'std' => 'false',
    					'class' => 'collapsed',
    					'type' => 'checkbox' );
	$options[] = array( 'name' => __( 'News shortcode', 'manuel' ),
	    				'desc' => __( 'shortcode für eigenen newsfeed eingeben', 'Manuel' ),
	    				'id' => $shortname . '_homepage_news',
	    				'std' => 'shortcode für eigenen newsfeed eingeben',
	    				'class' => 'hidden',
	    				'type' => 'textarea' );									
